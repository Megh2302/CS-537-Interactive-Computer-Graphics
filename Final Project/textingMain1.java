...
public class textingMain1 implements GLEventListener, KeyListener
{
     ...
     * Constructor
     */
    public textingMain1( GLCanvas G )
    {
        vbuffer = new int[7];
        ebuffer = new int[7];
        numVerts = new int[7];
     ...
     */
    public void animate() {
        angles[shapes.OBJ_SPHERE] += 0.2;
        angles[shapes.OBJ_TEAPOT] += 0.2;
	...
	gl3.glDrawElements( GL.GL_TRIANGLES, numVerts[shapes.OBJ_TEAPOT],
        ...
        // set up transformations for the cap
        myView.setUpTransforms( pshader, gl3,
                0.5f, 0.5f, 0.5f,
                0.0f, angles[shapes.OBJ_CONE], 0.0f,
                -0.07f, 2.30f, -1.5f
            );
        
        // draw it
        selectBuffers( pshader, shapes.OBJ_CONE, gl3 );
        gl3.glDrawElements( GL.GL_TRIANGLES, numVerts[shapes.OBJ_CONE],
            GL.GL_UNSIGNED_SHORT, 0l
        );
        // third, the sphere
        gl3.glUseProgram( pshader );
	...
	myPhong.setUpPhong( pshader, gl3 );
        ...
        myView.setUpTransforms( pshader, gl3,
                1.0f,1.0f, 1.0f,
                0.0f, angles[shapes.OBJ_SPHERE], 0.0f,
                -0.35f, -1.16f, -1.5f
            );
        
        // draw it
        selectBuffers( pshader, shapes.OBJ_SPHERE, gl3 );
    ...
    public static void main(String [] args)
    {
        ...
        textingMain1 myMain = new textingMain1(canvas);

        frame = new Frame( "SNOWMAN" );
